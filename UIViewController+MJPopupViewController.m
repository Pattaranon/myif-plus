...
- (void)dismissPopupViewControllerWithanimationType:(MJPopupViewAnimation)animationType
{
    ...
    UIView *popupView = [sourceView viewWithTag:TagSet+1];

    UIView *overlayView = [sourceView.superview viewWithTag:TagSet+2];
...
- (void)presentPopupView:(UIView*)popupView animationType:(MJPopupViewAnimation)animationType dismissed:(void(^)(void))dismissed
{
    ...
    UIView *sourceView = [self topView];
    sourceView.tag = TagSet;
    popupView.autoresizingMask = UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleLeftMargin |UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleRightMargin;
    popupView.tag = TagSet+1;
